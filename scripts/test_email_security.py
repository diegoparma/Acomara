...
def test_language_redetect_after_reset_source() -> None:
    session_vars = {
        "conversation_language": "es",
        "conversation_language_source": "reset",
    }
    detected = server.get_session_language(session_vars, "hello, how are you?")
    _assert(detected == "en", "language should be re-detected from first post-reset user message")

    cmd_detected = server.get_session_language(session_vars, "/version")
    _assert(cmd_detected == "es", "commands should not override reset session language")
...
if __name__ == "__main__":
    ...
    test_language_redetect_after_reset_source()
